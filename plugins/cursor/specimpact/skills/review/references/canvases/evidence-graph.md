...
> Projection only. Local `.specimpact/*.jsonl` is authoritative. Nodes, relations, aliases, and
> proposals must be read from SpecImpact resources or reports before rendering.
