...
> Markdown projection only. This template combines reviewable records for scanning; it does not
> persist decisions. Use the corresponding SpecImpact review tool with an explicit human decision.
